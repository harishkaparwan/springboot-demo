...
$(document).ready(function(){
	...
	var tableHeader='<table class="ui celled table"> <thead> <tr><th>Name</th> <th>city</th> <th>state</th> </tr></thead> <tbody>';
			 ...
			 $.ajax({
				  ...
				  success: function(result){
					  ...
					  for(var i=0; i< result.length; i++){
						  var tr= '<tr><td>'+result[i].name+' </td> <td>'+result[i].city+' </td>  <td> '+result[i].state+' </td> </tr> ';
